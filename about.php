...
<body>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <a class="text-body pr-3" href=""><i class="fa fa-phone-alt mr-2"></i>+91 217 2656377

                    </a>
                    <span class="text-body">|</span>
                    <a class="text-body px-3" href=""><i class="fa fa-envelope mr-2"></i>info@vishakatex.com
    ...
    <div class="container-fluid py-5 mb-5 wow fadeIn" style="background: linear-gradient(rgba(0, 0, 0, .5), rgba(0, 0, 0, .5)), url(img/innerbg.jpg) center center no-repeat; background-size: cover;" data-wow-delay="0.1s"> 
        <div class="container py-5">
            <h1 class="display-1 text-white animated slideInDown" style="text-align:center;">About Us</h1>
            <a href="index.php" ><h4 style="text-align:center; color:white;">Home</a>/&nbsp;About Us</h4>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="img/abouttowel.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">

                    <h1 class="display-5 mb-4">Welcome to Vishaka Tex</h1>
                    <p>Vishaka Industries Part of reputed business “kodam Group”, has grown manifold since its inception in the year 1968, having production capacity of 800 tons of Terry Towel & Toweling cloth annually.
                        ...
                        Entered into the cotton yarn business in the year 2001. Now our State of the art technology weaving facility includes Smit Textiles (Italy) weaving machines with Staubli (France) Jacquard machines. We at Vishaka Industries use (BCI) Best Cotton Initiative Certified cotton yarn as per our customers requirement. Our innovating designs meet the customers need. We are committed to improve every single loop so that the best quality reaches our customer.                    <p class="mb-4">Entered into the cotton yarn business in the year 2001. Now our State of the art technology weaving facility includes Smit Textiles (Italy) weaving machines with Staubli (France) Jacquard machines. We at Vishaka Industries use (BCI) Best Cotton Initiative Certified cotton yarn as per our customers requirement. Our innovating designs meet the customers need. We are committed to improve every single loop so that the best quality reaches our customer.</p>
                    <p class="mb-4">Product Range:- We are specialized in manufacturing Jacquard Beach Towel (velour wash finished), Jacquard Fouta towels (One side terry), Piece dyed Jacquard border terry bath towels, Institutional Towels (with logo’s of hospitality institutions)

                        uct Range:- We are specialized in manufacturing Jacquard Beach Towel (velour wash finished), Jacquard Fouta towels (One side terry), Piece dyed Jacquard border terry bath towels, Institutional Towels (with logo’s of hospitality institutions)</p>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                    <div class="fact-icon">
                    <i class="<?php echo $rw[1];?>" aria-hidden="true" style="font-size:48px"></i>    

                    <!-- <img src="img/icons/icon-2.png" alt="Icon"> -->
                    </div>
                    <h3 class="mb-3"><?php echo $rw[2];?></h3>
