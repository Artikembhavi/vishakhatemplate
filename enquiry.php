...
if(isset($_POST['btn']))
{
	...
	$add=$_POST['add'];
	$des=$_POST['des'];
        $sql="insert into enquery(Name,Email,Mobilenumber,Address,Description)
...
<body>
    ...
    <div class="container-fluid py-5 mb-5 wow fadeIn" style="background: linear-gradient(rgba(0, 0, 0, .5), rgba(0, 0, 0, .5)), url(img/innerbg.jpg) center center no-repeat; background-size: cover;" data-wow-delay="0.1s"> 
        ...
        <h1 class="display-1 text-white animated slideInDown" style="text-align:center;">Enquiry</h1>
            <a href="index.php" ><h4 style="text-align:center; color:white;">Home</a>/&nbsp;Enquiry</h4>
