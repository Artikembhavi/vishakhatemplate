...
if(isset($_POST['btn']))
{
	...
	$message=$_POST['message'];
        $sql="insert into contact(Your_Name,Email,Subject,Mobilenumber,Message)
...
<body>
    ...
    <div class="container-fluid py-5 mb-5 wow fadeIn" style="background: linear-gradient(rgba(0, 0, 0, .5), rgba(0, 0, 0, .5)), url(img/innerbg.jpg) center center no-repeat; background-size: cover;" data-wow-delay="0.1s"> 
        <div class="container py-5">
            <h1 class="display-1 text-white animated slideInDown" style="text-align:center;">Contact Us</h1>
            <a href="index.php" ><h4 style="text-align:center; color:white;">Home</a>/&nbsp;Contact Us</h4>
                ...
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <input type="tel" class="form-control p-4" placeholder="Mobilenumber" required="required" name="mobile">
                            </div>
                            <div class="form-group">
                                <input type ="text"class="form-control py-4 px-4" rows="5" placeholder="Message" required="required" name="message" style="margin-top:20px">
                            </div>
                            <div>
